...
public enum SpecializedCategoriesEnum {
    ...
    OFFICE_FURNITURE_AND_APPLIANCE_PURCHASE_REPAIR("办公家具和电器采购及维修", "办公家具和电器采购及维修", "cmp0y2rse004e3b716tihbjhf", "A01"),
    ...
    VENUE_NETWORK_COMMUNICATION("场馆网络及通讯", "场馆网络及通讯", "cmp0y2rse004e3b716tihbjhf", "A02,B02,B04,B05,B09,C02,C04"),
    ...
    GIFT_PURCHASE("礼品采买", "礼品采买", "cmp0y2rse004e3b716tihbjhf", "A04,B02,B03,B07,B10,C02"),
    ...
    EVENT_ACTIVITY_PLANNING_AND_PACKAGE("赛事/活动策划与整包", "赛事/活动策划与整包", "cmp0y2rse004e3b716tihbjhf", "A04,A09,B02,B03,B04,B07,B09,B10,C02,C04"),
    ...
    CLOUD_SERVICE("云服务", "云服务", "cmp0y2rse004e3b716tihbjhf", "A02,A04,B02,B04,B05,B09,C02,C04"),
    ...
    OFFICIAL_SIGNING_FEE("官签签约金", "官签签约金", "cmp0y2rse004f3b71rrqup04i", "B06"),
    SIGNING_FEE("签约金", "签约金", "cmp0y2rse004f3b71rrqup04i", "B06"),
    TRANSFER_FEE("转会费", "转会费", "cmp0y2rse004f3b71rrqup04i", "B06"),
    ...
    EVENT_APPROVAL_SUPPORT_SERVICE("活动报批相关保障服务", "活动报批相关保障服务", "cmp0y2rse004e3b716tihbjhf", "B02,B04,B09,C02,C04"),
    ...
    EVENT_SPONSORSHIP("赛事赞助", "赛事赞助", "cmp0y2rse004f3b71rrqup04i", "B03,B07,B10"),
